...
plot(twodays$newDateTime,as.numeric(as.character(twodays$Voltage)),type="l",xlab="datetime",ylab="Voltage")
...
legend("topright", lty=1, col = c("black", "red", "blue"), legend = c(lgnd), bty = "n", , pt.cex = 0.8, cex = 0.8)

plot(twodays$newDateTime,as.numeric(as.character(twodays$Global_reactive_power)),type="l",xlab="datetime",ylab="Voltage")
